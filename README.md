...
Posteroom modifications began on 2026-09-02. The current version is `0.4.2-posteroom.12` (WordPress plugin `0.1.4`), adding a compact Full HD desktop layout while retaining the resilient, same-origin guest WooCommerce cart flow. Git history records the modified files and dates.
